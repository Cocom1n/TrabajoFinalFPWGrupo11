...
export class Scenelose extends Phaser.Scene {
    ...
    preload() {
        this.load.image('fondoperdiste', '../../img/Nave/perdiste.png');
        this.load.image('botonreiniciar', '../../img/Nave/botonreiniciar.png');
        this.load.image('botonmenu', '../../img/Nave/botonmenu.png');
    }
