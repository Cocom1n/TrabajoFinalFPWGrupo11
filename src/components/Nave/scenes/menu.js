...
export class Menu extends Phaser.Scene{
    ...
    preload() {
        this.load.image('fondo', '../img/Nave/fondo-cielo.png');
        this.load.image('botonJugar', '../img/Nave/boton.png');
        this.load.spritesheet('nave','../img/Nave/nave.png',{frameWidth:70,frameHeight:62});
        this.load.spritesheet('naveEnemy','../img/Nave/enemy2.png',{ frameWidth: 70, frameHeight: 62 });
