...
export class Scene2 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('nave2', '../img/Nave/nave2.png', { frameWidth: 71, frameHeight: 62 });
        this.load.spritesheet('enemy2', '../img/Nave/enemy2.png', { frameWidth: 70, frameHeight: 62 });
        this.load.spritesheet('explosion', '../img/Nave/explosion.png', { frameWidth: 30, frameHeight: 30 });
        this.load.spritesheet('dano', '../img/Nave/navedaño.png', { frameWidth: 71, frameHeight: 62 });
        this.load.image('boss', '../img/Nave/naveGrande.png');
        this.load.image('noche', '../../img/Nave/nigth.png');
        this.load.image('fire', '../../img/Nave/yellow.png');
        // this.load.image('bigshoot', '../../public/img/bigshoot.png');
        this.load.image('bala', '../../img/Nave/shoot.png');
        this.load.image('disparoEnemigo', '../../img/Nave/shootEnemy.png');
        this.load.image('superDisparoEnemigo', '../../img/Nave/red.png');
        //Bonus para el jugador
        this.load.image('bonus', '../../img/Nave/Bonus.png');
        this.load.audio('msc_level_2', '../../sonido/Nave/msc_level_2.mp3');
        this.load.audio('msc_boss_fight', '../../sonido/Nave/bgmlvl1.mp3');
        this.load.audio('laser', '../../sonido/Nave/blaster-11.mp3');
        this.load.audio('crash', '../../sonido/Nave/crash.mp3');
        this.load.audio('MG', '../../sonido/Nave/heavy-machine-gun.mp3');
    }
    ...
    create() {
        ...
        //sonido para cuando el jugador agarra el bonus
        this.bonusSound = this.sound.add('MG');
        // Cooldowns de disparos del player
        this.cooldownBullet = {
            cooldown: 100,
            nextTimeShoot: 0
        };
        ...
        this.input.keyboard.on('keydown-SPACE', () => {
            ...
            if (this.isBonusActive == true) {

                let nextBulletShoot = this.cooldownBullet.nextTimeShoot;
                if (nextBulletShoot > this.game.getTime())
                    return;
                this.laser.play();
                let bala = this.bullets.create(this.player.x + 10, this.player.y+10, 'bala');
                let bala2 = this.bullets.create(this.player.x + 10, this.player.y-10, 'bala');
        ...
        this.vidaPlayerText = this.add.text(500, 16, 'Vida Jugador: 100', { fontSize: '40px', fill: '#fff' });
    ...
    update(time) {
            ...
            if (this.puntos >= 1500) 
            {   
                //ejecuta solo un bonus para toda la partida
    ...
    //Metodo para actualizar la vida del jugador
    updatePlayerHealth() {
    ...
    crearBonus()
    {
        ...
        //Se crea el bonus con rebote y collider con los bordes del escenario
        this.Bonus = this.physics.add.sprite(750, 300, 'bonus');
        this.Bonus.setBounce(1); 
        this.Bonus.setCollideWorldBounds(true); 
        this.Bonus.setVelocity(Phaser.Math.Between(-300, 300), Phaser.Math.Between(-200, 200));
        //al chocar con el jugador se destruye y actva el ataque doble
        this.physics.add.overlap(this.player, this.Bonus, (player, bonus) => {
