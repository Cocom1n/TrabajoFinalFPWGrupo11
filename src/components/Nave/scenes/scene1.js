...
export class Scene1 extends Phaser.Scene {
    ...
    preload()
    {
        ...
        this.load.spritesheet('nave','../../img/Nave/nave.png',{frameWidth:70,frameHeight:62});
        this.load.image('enemigo', '../../img/Nave/enemy.png',{frameWidth:70,frameHeight:62} );
        this.load.image('fuego', '../../img/Nave/red.png');
        this.load.image('cielo', '../../img/Nave/sky.png');
        this.load.image('bala', '../../img/Nave/shoot.png');
        this.load.image('fire', '../../img/Nave/yellow.png');
        this.load.image('impact', '../../img/Nave/orange2.png');
        this.load.audio('laser', '../../sonido/Nave/blaster-11.mp3');
        this.load.audio('crash', '../../sonido/Nave/crash.mp3');
        this.load.audio('musica', '../../sonido/Nave/msc_boss_fight.mp3');
    }
